# Least-Theater and Full-Standalone Execution Law
...
2. minimal;
3. explicit;
4. reproducible from this repository;
5. independent of Baby, Fix, Horsey, or another private StealthEye control plane.
...
5. whether standalone independence was preserved.
